...
SECRET_KEY = '&$h^avul7y*i7moi^gks!sb1s8v(_&p)u5kn)*ud*4n_r8vc@g'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # 注册cors中间件
...
SESSION_CACHE_ALIAS = "session"  # 让他缓存到1号数据库的配置下
...
EMAIL_HOST_PASSWORD = 'python99'  # 邮箱授权时获取的密码
...
# 支付宝  pqcanx4910@sandbox.com
ALIPAY_APPID = '2016092800618125'
...
CALLBACK_URL = 'http://www.meiduo.site:8000/sina_callback'
